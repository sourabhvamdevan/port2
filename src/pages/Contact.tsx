...
import React, { useState } from "react";
import { Mail, Copy, Check, Github, Twitter, Send } from "lucide-react";
        ...
        >
          <div className="space-y-5">
            <div className="flex items-center justify-between gap-4">
              <a
                href={`mailto:${email}`}
                className="inline-flex items-center gap-2 text-sm font-medium text-gray-800 dark:text-gray-200 break-all"
              >
                <Mail size={16} />
                {email}
              </a>
            ...
            <div className="flex gap-4 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600"
              >
                <Github size={16} />
                GitHub
              </a>
